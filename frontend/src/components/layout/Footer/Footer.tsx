        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerBottom}>
            ...
            <div className={styles.footerCredit}>
              <p>
                Desarrollado con ❤️ por <a href="https://bytesofjose.github.io/" target="_blank" rel="noopener noreferrer" className={styles.creditLink}>Jose Garcia</a>
              </p>
            </div>
          </div>
        </div>
